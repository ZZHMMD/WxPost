                    ...
                    <div class="weui-cells weui-cells_form">
                        ...
                        <div class="weui-cell">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <div class="weui-cell__bd">
                                        <input type="text" name="tel" class="weui-input" value="${result.obj.phoneNum}"
                                               readonly="readonly"/>
                                    </div>
                                </c:otherwise>
                            </c:choose>
                            <c:if test="${result.obj.phoneNum ==null}">
                                <div class="weui-cell__ft" id="code">
                                    <button id="getCode" data-flag="first" class="weui-vcode-btn" dsiabled="disabled">
                                        获取验证码
                                    </button>
                                </div>
                            </c:if>
                        ...
                        <div class="weui-cell">
                            ...
                            <div class="weui-cell__bd">
                                <input type="text" name="student_card_num" value="${result.obj.studentCardNum}"
                                       class="weui-input" pattern="[0-9]*"/>
                            </div>
                        </div>
                        <div class="weui-cell">
                            <div class="weui-cell__hd">
                                    ...
                                    <div class="weui-uploader__bd">
                                        <ul class="weui-uploader__file" id="uploaderFiles">
                                            <li class="weui-uploader__file"
                                                style="background-image:url(../../assert/images/pic_160.png)"
                                                id="imgli">
                                                <c:choose>
                                                    <c:when test="${result.obj.studentCard !=null}">
                                                        <img data-flag="unchange"
                                                             style="width:100%;height:100%; z-index:999;" id="stu_img"
                                                             src="/WxPost/images/${result.obj.studentCard}"/>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <img data-flag="unchange"
                                                             style="width:100%;height:100%; z-index:999;" id="stu_img"
                                                             src="../../assert/images/pic_160.png"/>
                                                    </c:otherwise>
                                                </c:choose>
                                            </li>
                                        </ul>

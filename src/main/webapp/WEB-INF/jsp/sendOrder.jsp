                        ...
                        <div class="weui-cells weui-cells_form">
                            <div class="weui-cell" style="margin-top:10px;">
                                ...
                                <div class="weui-cell__bd">
                                    <input type="number" name="receiveNum" class="weui-input" pattern="[0-9]*"
                                           placeholder="4~6位取货码"/>
                                </div>
                            </div>
                            <div class="weui-cell">
                            ...
                            <div class="weui-cell">
                                ...
                                <div class="weui-cell__bd">
                                    <textarea type="text" name="descration" class="weui-textarea" rows="3"
                                              placeholder="根据您的快递类型提出相应的要求，例如易损坏等，该项为选填!"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>

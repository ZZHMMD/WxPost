                        ...
                        <div class="weui-form-preview">
                            ...
                            <div class="weui-form-preview__bd">
                                ...
                                <div class="weui-form-preview__item">
                                    ...
                                    <span class="weui-form-preview__value"><img src="/WxPost/images/${item.studentCard}"
                                                                                data-url="${item.studentCard}"
                                                                                class="studentCard"/></span>
                                </div>
                                <div class="weui-form-preview__item">
                            ...
                            <div class="weui-form-preview__ft">
                                <a href="tel:13330308503"
                                   class="weui-form-preview__btn weui-form-preview__btn_primary orderCancel">联系客服</a>
                                <input type="hidden" value="${item.fetchg}">
                                <c:choose>
                                    <c:when test="${item.fetchg}">
                                        <a href="javascript:;" data-id="${item.orderId}"
                                           class="weui-form-preview__btn weui-form-preview__btn_primary editReceive">已取货</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="javascript:;" data-id="${item.orderId}"
                                           class="weui-form-preview__btn weui-form-preview__btn_default unReceive">未取货</a>
                                    </c:otherwise>
                                </c:choose>
                            </div>
                        </div>

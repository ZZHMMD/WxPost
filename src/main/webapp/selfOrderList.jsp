						...
						<li class="xb-pdTop">
							<div class="weui-form-preview">
								...
								<div class="weui-form-preview__ft">
									...
									<a href="javascript:;" data-id="${item.id}" class="editOrder weui-form-preview__btn weui-form-preview__btn_default" >修改订单</a>
									</c:when>
									<c:otherwise>
									<a href="javascript:;" data-id="${item.id}" class="weui-form-preview__btn weui-form-preview__btn_primary orderConfirm">确认收货</a>
									</c:otherwise>
									</c:choose>
								</div>
							</div>
						...
						<div class="js_dialog" id="confirmDialog" style="display: none;">
							...
							<div class="weui-dialog">
								...
								<div class="weui-dialog__ft">
									...
									<a href="javascript:;" class="weui-dialog__btn weui-dialog__btn_primary" id="confirmBtn">确认</a>
								</div>
							</div>
						</div>
					</div>

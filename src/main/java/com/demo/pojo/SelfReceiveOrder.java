...
public class SelfReceiveOrder implements Serializable {
	...
	public String getShowReceiveOrderTime() {
		return showReceiveOrderTime;
	}
	public void setShowReceiveOrderTime(String showReceiveOrderTime) {
		this.showReceiveOrderTime = showReceiveOrderTime;
	}
